// TS 38.212 V18.4.0 Tables 5.3.2-1 through 5.3.2-3.
// Base-graph coefficients were cross-checked against NVIDIA Sionna 04ddb93.

pub const LIFTING: [&[u16]; 8] = [
